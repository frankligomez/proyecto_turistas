...
DEFINE('_EW_DESC_UNINSTALL_KEEP_DATA', "<span style='color:red'>Backup your DB tables first if using this option!</span>Mantenere le tabelle del database in caso di disinstallazione. Selezionare questa opzione prima della disinstallazione se si sta effettuando un aggiornamento e si desidera mantenere i dati.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
