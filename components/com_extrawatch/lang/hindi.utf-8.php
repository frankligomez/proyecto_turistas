...
DEFINE('_EW_DESC_UNINSTALL_KEEP_DATA', "<span style='color:red'>Backup your DB tables first if using this option!</span>स्थापना रद्द पर डाटाबेस टेबल्स रखें. इस विकल्प की जाँच के पहले की स्थापना रद्द अगर आप एक उन्नयन कर रहे हैं और अपने डेटा रखना चाहते हैं.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_CONFIG_LICENCE_DONT_MATCH', "<b> गलती: लाइसेंस कुंजी और अपने डोमेन से मेल नहीं खाती |</b><br/>क्या तुम एक आप नीचे देख के रूप में दान के रूप में एक ही डोमेन नाम दर्ज? <br/>Click '<b>सही सक्रियकरण अनुरोध key</b>' नीचे,या contact: support@codegravity.com<br/>");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
