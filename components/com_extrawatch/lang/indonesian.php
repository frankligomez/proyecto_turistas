...
DEFINE('_EW_DESC_UNINSTALL_KEEP_DATA', "<span style='color:red'>Backup your DB tables first if using this option!</span>Tetap simpan tabel database sewaktu menghapus instalasi. Pilih pilihan ini sebelum menghapus instalasi jika anda melakukan upgrade dan ingin menjaga data tetap ada.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_STATS_FOOTER', "ExtraWatch &copy;2006-%s oleh CodeGravity.com");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
