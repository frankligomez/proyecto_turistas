...
DEFINE('_EW_VISITS_MODULE_NOT_PUBLISHED', "������ ����� JoomlaWach �� � ����������.�� ���� �� �� �������� ������� ������������� �����. ������� � ������ ������ � �� �������� ����� ExtraWatch - �� �� ��������� ��� ������ ��������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_STATS_IP_BLOCKING_MANUALLY', "�������� IP ������, ����� ������ �� ���������. (����. 217.242.11.54 ��� 217.* ��� 217.242.* �� ��������� �� ������ ���� �����������)");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_STATS_IP_BLOCKING_TOGGLE', "������������ �� ��������� IP ������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_AJAX_PERMISSION_DENIED_1', "AJAX ������ ���������: ����, ����������� ������������ �� �������, ����� ��� �������� � configuration.php �� ������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
// Tooltips.
DEFINE('_EW_TOOLTIP_CLICK', "�������� �� �� �������� tooltip ���������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_TOOLTIP_MOUSE_OVER', "������� � ������� �� tooltip �� �� �������� ���������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_GOALS_TITLE_CONDITION', "��������-���������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_GOALS_USERNAME_CONDITION', "������������� ���-���������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_GOALS_DELETE_CONFIRM', "��� �� �������� ������ ������������ ������������� ����� �� ���� ���. �������� �� ������ �� �������� ������?");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_DESC_DEBUG', "ExtraWatch � � debug �����. �� ���� ����� �� ����� �� �� ��������� ��������� �� ������. �� �� ���������, ����, ��������� ���������� EXTRAWATCH_DEBUG � /components/com_extrawatch/config.php �� 1 �� 0");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_STATS_MAX_ROWS', "���������� ���� �� �������� �� ����� ���� ����������� � �������� �� ������������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_STATS_IP_HITS', "������ IP ������, ����� ���� ��-����� ������ �� ���������� ���, �� ����� ������� �� ��������� �� IP ������.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_STATS_URL_HITS', "������ URL ������, ����� �� ��-����� ������ �� ���������� ���, �� ���� �������� �� ��������� URL ������.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_IGNORE_IP', "���������� �� IP ����� � ������������.����� ����� ������� �� ��� ���. ������ �� ���������� ���������. <br/>��������. 192.* �� �������� 192.168.51.31, 192.168.16.2, � �.�..");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_UPDATE_TIME_VISITS', "��������������� �� ����������� �� ������������ � ����� �����, � �����������, �� ������������ 2000, ������ ���������� � ���� ���������.�� �� ��� �����, �������� ���� ��������������� ���������� � ExtraWatch.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_UPDATE_TIME_STATS', "��������������� �� ����������� �� ������������ � ������ ����� � �����������, ���������� 2000, ������ ���������� � ���� ���������. � �� ��� �����, �������� ���� ��������������� ���������� � ExtraWatch.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_MAXID_BOTS', "����� ������ �� �� ���������� � ������ �����.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_MAXID_VISITORS', "����� ������ �� ������������ �� �� ���������� � ������ �����.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_LIMIT_BOTS', "����� ������ �� �� ������ � ����� ����� � ����������������� ���������.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_LIMIT_VISITORS', "����� ������������ �� �� ������ � ����� ����� � ����������������� ���������.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_TRUNCATE_VISITS', "�������� �������, ����� �� ����� �������� ��� ����� �������� � URI ������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_TRUNCATE_STATS', "�������� �������, ����� �� �� ����� �������� ��� ����� �������� � ������ ������������� �����");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_STATS_KEEP_DAYS', "���� ���, ���� ����� �� �� ������ ������ ������� �� ��������������� ����� � ������ �����. 0 = �����������.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_TIMEZONE_OFFSET', "��� ��� � �������� ������ ���� �� ������� ��, �� ����� �������� ����� ��.(�������� ����������� ��� ����������� �����, ���� ��������� � ������ ����)");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_WEEK_OFFSET', "��������� � ������� �� ���������, Timestamp/(3600*24*7) ����� ������ �� ��������� �� 1.1.1970, ���� ������� � �������� �� ���������, ��������� � ����������. ��� �������� ������, �� � ���������� �� �� �������.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_DAY_OFFSET', "��������� � ������� �� ����, �imestamp/(3600*24) ����� ������ �� ���� �� 1.1.1970, ���� ������� � ��������, �� �� ������� ����� �� 00:00. ��� �������� ������, �� � ���������� �� �� �������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_FRONTEND_HIDE_LOGO', "<b>(����������� � ����������� ������)</b> ���� �� ���������� ������ ����� 1x1px � ��������� ��������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_IP_STATS', "���������� �� IP ����� � ������������. � ����� ������, IP ������ �� ����� �� ����� �����. ����������� �� ���� �������� ����.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_HIDE_ADS', "���� ��������� ������ ���������, ��� �� �������� �� �������.� ������������ ��, ��� ���������� ��-����������� �������� �� ���� ����������. ���������.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_TOOLTIP_ONCLICK', "��� ������ �� �� ������� ������������� � ������� �������� ����� � �����, ��������� ������� ����� �������, ������ �� ��������.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_SERVER_URI_KEY', "�� ������������ ���� ��������� � 'REDIRECT_URL', ��� ���������� url rewriting, ������ �� ��������� �� 'SCRIPT_URL' ��� ��� ������ ���������� �� ������� ���� index.php");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_BLOCKING_MESSAGE', "���������, ����� ������� ������������ ���������� �� ������� �����, ���� �� ���� ����������� ���������.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_TOOLTIP_WIDTH', "������ �� ��������� � tooltip");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_TOOLTIP_HEIGHT', "�������� �� ��������� � tooltip");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_TOOLTIP_URL', "��� ������ �� �������� �������� ����� �� ������������� �� ������������� IP �����.{ip} �� ���� ������� �� �������� IP ������ �� �����������. ��������: http://somewebsite.com/query?iplookup={ip}");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_IGNORE_URI', "������ �� �������� �������� URI, ����� ������ �� ���� ��������� �� ����������. ������ �� ���������� ���������� ������� (* � ?) ���. ����. : /freel?n* ");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_DESC_GOALS_GET_VAR', "GET ���������� � ���������� ����, ����� ������� � URL ���������� ����  ����� ? ��� & amp; ��������: http://www.codegravity.com/index.php?<u>���</u>u=peter&amp;<u>�������</u>=smith.������ ���� �� ���������� <u>*</u> � ���� ����, �� ������ GET ����������.(������: <b>n*me</b>)");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_GOALS_GET_CONDITION', "��� ������ �� ���������� �� ����� �� �� ����� ������������ � ���������� ����.(������: <b>p?t*r</b>) ");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_GOALS_POST_VAR', "���� �������, �� ��������� �����������, ������� ��� ���������. ����, �� ��� ����� �� �������� �� ��������, ����� ��� ���� �� ��������� &lt;input type='text' name='<u>�����������</u>' /&gt;. (������: <b>expert*ces</b>)");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_DESC_GOALS_REDIRECT', "��� ���� ������� �� ���������, ������ �� ����������� �����������  ��� ����� �� ��� �����. ��� ��-����� ���������, ��������� '��������': (������: <b>http://www.codegravity.com/chod-prec.html</b>)");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_TRUNCATE_GOALS', "����� ������� �������� �� �� �������� � ��������� �� ����� �����");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_DESC_FRONTEND_VISITORS_TOTAL', "������� �� ������������ �� ����� ���� ���� ������������ �� ExtraWatch. ��� ��������� �����������, ������ �� �������� �� ������ ������� � CACHE_FRONTEND_  �� �� �������� ���������.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_LANGUAGE', "������ ����, ����� �� ����������. ��������� ������� �� ������� � /components/com_extrawatch/lang/. �� �� �������� ��� ����, ����� �� �������, �� ��� ���� �� � �� ���������� �� ���� ������. ��� ��� �� ����, ��������� english.php � �� ������������� �� mojjazyk.php �������� � �� ��������� �� ��-������ �����. ��������� ������ ������ � �����. ���-����� � �� ���������� ��������� UTF-8");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_GOALS_COUNTRY_INVERSED', "������� ������� ���������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_GOALS_COUNTRY_CONDITION', "������������ ��� �� ������ ������� (����.: <b>TH</b>)");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_DESC_FRONTEND_VISITORS_TOTAL_INITIAL', "������������ �������� '����:' �� �����. �������, ��� ��� ��������� �� ���� ������������� ����������. (����. 20000). ��� �� ������ �� ���������� ���� ������� ��������� 0.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_IGNORE_USER', "��������� ������������� �� ���� textbox. ������������� ��� ��-����. (����.: myself {��� ���} mark_*) ");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_DESC_FRONTEND_USER_LINK', "�����, ������� �� � ������� ������������� �����, ����� �� ��������� �� �������� ���������� URL,����� � �������, ������ ������������ ������ ����� ��������������� �� ���. ������ �� ������� ���� {user}, ����� �� ���� ������� � ���������� ��� �� �����������. (����. index.php?option=com_comprofiler&task=userProfile&user={user}) ");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_DESC_UNINSTALL_KEEP_DATA', "<span style='color:red'>Backup your DB tables first if using this option!</span>�������� ��������� � ������ ����� �� �������������. �������� ���� �����, ����� �� �������������, ��� ������� ������� � ������ �� �������� ������� ��.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  

/* email reports */
DEFINE('_EW_DESC_EMAIL_REPORTS_ENABLED', "�� �������� ����� ����� ������ � ������ �� ���������� ���, ����� ������ �� ��������� �� ��������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_EMAIL_REPORTS_ADDRESS', "�����  ������, �� ����� �� �������� ���� ������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_EMAIL_PERCENT_HIGHER_THAN', "������� ���� �� ���������� ������ � ������������ ����, ������ ���� ������� � ��-������ �� {value}. ������� 0, ��� �� ������ �� �������� ���� ������� <i>(example: 5)</i>");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_EMAIL_ONE_DAY_CHANGE_POSITIVE', "������� ���� <b> �� ���� ��� </b> ����������� ������� �� ���������� � ������ �� �������� �� ��-�����  {value} �������. ������� 0, ��� �� ������ �� �������� ���� ������� <i>(example: 5)</i>");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_EMAIL_ONE_DAY_CHANGE_NEGATIVE', "������� ���� <b> �� ���� ��� </b> ����������� ������� �� ���������� � ������ �� �������� �� ��-����� {value} �������. ������� 0, ��� �� ������ �� �������� ���� ������� <i>(example: -10)</i>");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_EMAIL_SEVEN_DAY_CHANGE_POSITIVE', "������� ���� <b> �� ����� ��� </b> ����������� ������� �� ���������� � ������ �� �������� �� ��-�����  {value} �������. ������� 0, ��� �� ������ �� �������� ���� ������� <i>(example: 2)</i>");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_EMAIL_SEVEN_DAY_CHANGE_NEGATIVE', "������� ���� <b> �� ����� ��� </b> ����������� ������� �� ���������� � ������ �� �������� �� ��-����� {value} �������. ������� 0, ��� �� ������ �� �������� ���� ������� <i>(example: -13)</i>");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_EMAIL_TWENTY_EIGHT_DAY_CHANGE_POSITIVE', "������� ���� <b> �� �������� ��� </b> ����������� ������� �� ���������� � ������ �� �������� �� ��-�����  {value} �������. ������� 0, ��� �� ������ �� �������� ���� ������� <i>(example: 2)</i>");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_EMAIL_TWENTY_EIGHT_DAY_CHANGE_NEGATIVE', "������� ���� <b> �� �������� ��� </b> ����������� ������� �� ���������� � ������ �� �������� �� ��-����� {value} �������. ������� 0, ��� �� ������ �� �������� ���� ������� <i>(example: -13)</i>");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_FRONTEND_NOFOLLOW', "<b>(����������� � PRO ������)</b> ����������� ���� ���������, ��� ������ �� ��������� �������� � ������ ���� �������� rel='nofollow' ");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_EMAIL_NAME_TRUNCATE', "���������� ���� ����� �� ��� �� ��� �� ������. ��������� ����, ��� ����� ����� �������� �� ��������� � ������ �����");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  

/* email reports - sergej*/  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_EMAIL_REPORTS_ENABLED', "����� ������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_EMAIL_REPORTS_ADDRESS', "����� �����");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_EMAIL_NAME_TRUNCATE', "���������� ������ �� ��� �� ������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_EMAIL_PERCENT_HIGHER_THAN', "������� �� ���������� ������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_EMAIL_ONE_DAY_CHANGE_POSITIVE', "������ ���� �� ���� ��� ������������� �������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_EMAIL_ONE_DAY_CHANGE_NEGATIVE', "������ ���� �� ���� ��� ����������� �������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_EMAIL_SEVEN_DAY_CHANGE_POSITIVE', "������ ���� �� ����� ��� ����������� �������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_EMAIL_SEVEN_DAY_CHANGE_NEGATIVE', "������ ���� �� ����� ��� ����������� �������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_EMAIL_TWENTY_EIGHT_DAY_CHANGE_POSITIVE', "������ ���� �� �������� ��� ����������� �������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_EMAIL_TWENTY_EIGHT_DAY_CHANGE_NEGATIVE', "������ ���� �� �������� ��� ����������� �������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
/* email reports - sergej*/  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  

DEFINE('_EW_MENU_HISTORY', "�������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_MENU_EMAILS', "������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_MENU_STATUS', "������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_DESC_BLOCKED', "���� IP ������ �� ���� ��������� �� ����-����");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_EMAIL_REPORTS_VALUE_FILTERS', "����� �������� �� ��������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_GOALS_TITLE_INVERSED', "��������-������� ���������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_GOALS_USERNAME_INVERSED', "������������� ��� ������� ���������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_GOALS_CAME_FROM_INVERSED', "���� �� ������� ���������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_SIZEQUERY_BAD_REQUEST', "������ ������:");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_FLOW_OUTG_LINKS', "Root �������� ���� ������:");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_FLOW_NESTING', "����:");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_FLOW_SCALE', "�����:");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_COMERCIAL_AD_FREE', "��������� ������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_DESC_IPINFODB_KEY', "����� �� ���������� ��������� ��: <a href='http://www.ipinfodb.com/register.php' target='_blank'>ipinfodb.com</a>");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_IPINFODB_KEY', "IP ���������� �� DB ����");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_ONLY_LAST_URI', "���� �������� URI");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_FRONTEND_HIDE_LOGO', "����� ������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_FRONTEND_NOFOLLOW', "�������� � ������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
/***********EDITs*****************/  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
DEFINE('_EW_ANTISPAM_BLOCKING_TEXT', " �� �� �� ������� ���������, ������ �� ����������� ExtraWatch agent ����� �������� ���������� ��� �����. ����. �� ������ ������ ��� ����� ������.  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
                    <br/>  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
                   ����� � ����� ��������� -> ExtraWatch agent -> �������� ������� ���� ����");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
/* sergej */
DEFINE('_EW_EMAIL_SEO_REPORTS_ENABLED', "������ SEO �������");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
