...
DEFINE('_EW_DESC_UNINSTALL_KEEP_DATA', "<span style='color:red'>Backup your DB tables first if using this option!</span>Включете таблиците в базата данни за деинсталиране. Изберете тази опция, преди да деинсталирате, ако правите ъпгрейд и искате да запазите данните си.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_CONFIG_LICENCE_DONT_MATCH', "<b>Грешка: лицензния ключ и домейна Ви не съвпадат.</b><br/>Въвели ли сте едно и също име на домейна във формата, която виждате по-долу? Моля свържете се с : support@codegravity.com");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
