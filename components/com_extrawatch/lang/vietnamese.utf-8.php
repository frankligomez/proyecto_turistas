...
DEFINE('_EW_DESC_UNINSTALL_KEEP_DATA', "<span style='color:red'>Backup your DB tables first if using this option!</span>Giữ bảng cơ sở dữ liệu trên gỡ bỏ cài đặt. Kiểm tra tùy chọn này trước khi gỡ bỏ cài đặt nếu bạn đang làm một nâng cấp và muốn giữ lại dữ liệu của bạn.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_CONFIG_LICENCE_DONT_MATCH', "<b> Lỗi: các phím giấy phép và tên miền của bạn không phù hợp </b> <br/> Bạn nhập vào tên miền tương tự vào hình thức đóng góp là một trong những bạn xem dưới đây. <br/> Nhấp vào 'yêu cầu <b> đúng mã khóa kích hoạt </b>' dưới đây, hoặc liên hệ: support@codegravity.com <br/>");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
