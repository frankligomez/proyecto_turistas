...
DEFINE('_EW_DESC_UNINSTALL_KEEP_DATA', "<span style='color:red'>Backup your DB tables first if using this option!</span>Mantener las Tablas de la Base de Datos al desinstalar. Seleccione esta opción antes de desinstalar si va a actualizar a una versión mas reciente y desea conservar los datos.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
