...
DEFINE('_EW_DESC_UNINSTALL_KEEP_DATA', "<span style='color:red'>Backup your DB tables first if using this option!</span>Κράτημα πινάκων στην απεγκατάσταση. Επιλέξτε εδώ πριν την απεγκατάσταση άν αναβαθμίζετε και θέλετε να παραμείνουν τα δεδομένα.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
DEFINE('_EW_STATS_FOOTER', "ExtraWatch &copy;2006-%s από τον CodeGravity.com");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
