...
DEFINE('_EW_DESC_UNINSTALL_KEEP_DATA', "<span style='color:red'>Backup your DB tables first if using this option!</span>Podczas dezinstalacji zachowaj tabele bazy danych. Zaznacz tę opcję przez dezinstalacją, jeżeli dokonujesz aktualizacji komponentu lub chcesz zachować dane.");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
