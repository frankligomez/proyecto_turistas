...
<div class="mailto">
	...
	<form action="<?php echo JURI::base() ?>index.php" id="mailtoForm" method="post">
		<div class="control-group">
			<label class="control-label" for="mailto_field"><?php echo JText::_('COM_MAILTO_EMAIL_TO'); ?></label>
		...
		<p>
        <input type="button" class="btn btn-primary" onclick="return Joomla.submitbutton('send');" value="<?php echo JText::_('COM_MAILTO_SEND'); ?>" />
        <input type="button" class="btn btn-primary" onclick="return Joomla.submitbutton('send');" value="<?php echo JText::_('COM_MAILTO_CANCEL'); ?>" />
		</p>
